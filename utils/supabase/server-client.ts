...
// * The set and remove methods for the server client need error handlers, because Next.js throws an error if cookies are set from Server Components. You can safely ignore this error because you also set up middleware in the next step to write refreshed cookies to storage.
